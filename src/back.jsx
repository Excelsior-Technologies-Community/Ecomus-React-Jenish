...
function Home() {
  ...
  useEffect(() => {
    fetch("http://localhost:5001/bestseller")
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch("http://localhost:5002/happyclient")
      .then((res) => res.json())
  ...
  return (
    <>
      <div>
                  ...
                  <div className="w-full">
                    ...
                    <div className="herowrapcontent absolute bottom-40 left-28 text-start">
                      ...
                      <button
                        ...
                        className="bg-black hover:bg-blue-700 text-white py-2 px-4 flex"
                      >
                        Shop Collection
                        <span>
        ...
        {/* CATEGORIES SECTIONS  */}
        <section className="py-5">
          <div className="categories relative container">
            {/* Header with Buttons */}
            ...
            <div className="categoriesswiper grid grid-cols-1 md:grid-cols-4 gap-6 relative">
              ...
              >
                {categories.map((category) => (
                  <SwiperSlide key={category.id} className="SwiperSlide">
                    <div>
                      <img
                        src={category.image}
                        alt={category.title}
        ...
        <section className="py-5">
          <div className="container bestseller mx-auto max-w-7xl px-4">
                      ...
                      <div className="bestsellerhidedata">
                        <div className="block justify-items-center">
                          <button className="flex gap-2">
                            <BsCartCheck className="bestsellericons" />
                            <IoIosHeartEmpty className="bestsellericons" />
                            <MdCompareArrows className="bestsellericons" />
                            <MdOutlineRemoveRedEye className="bestsellericons" />
                          </button>
        ...
        {/* Shop the look */}
        <section className="py-5">
          <div className="container loopsection text-center">
            <h1>Shop the look</h1>
            <p>
        ...
        {/* Shop Gram */}
        <section className="py-5">
          <div className="container shopgram">
            ...
            >
              {shopgram.map((src, index) => (
                <SwiperSlide key={index} className="relative shopgramimage">
                  ...
                  />
                  <button>
                    <BsCartCheck className=" absolute bottom-0 top-[86px] left-[83px] right-0 bg-white rounded-full p-2 w-8 h-8" />
                  </button>
                </SwiperSlide>
              ))}
            </Swiper>
        ...
        <section className="py-5 bg-gray-100">
          <div className="container px-4 mx-auto">
            ...
            <div className="footer grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 md:gap-14">
              ...
              {/* Accordion Sections */}
              {["Help", "About Us", "Sign Up for Email"].map((section) => (
                <div
                  key={section}
                    ...
                    {section === "Sign Up for Email" && (
                      <div className="space-y-4">
                        ...
                        <div className="relative max-w-xs">
                          ...
                          />
                          <button className="absolute right-2 top-2 bg-black text-white px-3 py-1 rounded-md flex items-center">
